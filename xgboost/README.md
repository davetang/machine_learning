...
<!-- -->
    ...
    ## [04:55:29] WARNING: amalgamation/../src/learner.cc:1115: Starting in XGBoost 1.3.0, the default evaluation metric used with the objective 'binary:logistic' was changed from 'error' to 'logloss'. Explicitly set eval_metric if you'd like to restore the old behavior.
    ## [1]  train-logloss:0.228337 
...
Session info.
    ...
    ##  [1] SHAPforxgboost_0.1.1 xgboost_1.5.2.1      forcats_0.5.1       
    ...
    ## [17] checkmate_2.0.0    rvest_1.0.2        colorspace_2.0-3   htmltools_0.5.2   
    ## [21] Matrix_1.4-0       pkgconfig_2.0.3    broom_0.7.12       haven_2.4.3       
    ## [25] scales_1.1.1       tweenr_1.0.2       tzdb_0.3.0         ggforce_0.3.3     
    ## [29] generics_0.1.2     farver_2.1.0       car_3.0-12         ellipsis_0.3.2    
    ## [33] ggpubr_0.4.0       withr_2.5.0        cli_3.2.0          magrittr_2.0.3    
    ## [37] crayon_1.5.1       readxl_1.4.0       evaluate_0.15      fs_1.5.2          
    ## [41] fansi_1.0.3        MASS_7.3-55        rstatix_0.7.0      xml2_1.3.3        
    ## [45] tools_4.1.3        data.table_1.14.2  hms_1.1.1          lifecycle_1.0.1   
    ## [49] BBmisc_1.12        munsell_0.5.0      reprex_2.0.1       compiler_4.1.3    
    ## [53] rlang_1.0.2        grid_4.1.3         rstudioapi_0.13    rmarkdown_2.13    
    ## [57] gtable_0.3.0       abind_1.4-5        DBI_1.1.2          R6_2.5.1          
    ## [61] lubridate_1.8.0    knitr_1.38         fastmap_1.1.0      utf8_1.2.2        
    ## [65] stringi_1.7.6      Rcpp_1.0.8.3       vctrs_0.4.0        dbplyr_2.1.1      
